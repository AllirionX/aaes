    ...
    <?php if (!empty($images) && $stats['total_images'] > 0): ?>
        ...
        <ul id="galleryList" class="clearfix">
            ...
            <?php foreach ($images as $image): ?>
                <li><a href="<?php echo html_entity_decode($image['file_path']); ?>" title="<?php echo $image['file_title']; ?>" data-rel="<?php echo $relText; ?>"><img src="<?php echo $image['thumb_path']; ?>" alt="<?php echo $image['file_title']; ?>"/></a></li>
            <?php endforeach; ?>
