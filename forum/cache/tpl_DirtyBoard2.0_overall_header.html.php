...
<div><a class="header_js" id="header" name="header" accesskey="t" href="#footer" title="Go to footer">Go to footer</a></div>
	...
	<div id="submenu">
			<a href="#" class="sitehome" title="<?php echo ((isset($this->_rootref['L_HOME'])) ? $this->_rootref['L_HOME'] : ((isset($user->lang['HOME'])) ? $user->lang['HOME'] : '{ HOME }')); ?>"><?php echo ((isset($this->_rootref['L_HOME'])) ? $this->_rootref['L_HOME'] : ((isset($user->lang['HOME'])) ? $user->lang['HOME'] : '{ HOME }')); ?></a>
