...
*
* @package language
* @version $Id: profile.php 71 2013-07-23 21:38:34Z papicx $
...
$lang = array_merge($lang, array(
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Masque le champ de profil à tous les autres utilisateurs mis à part l’utilisateur concerné, les administrateurs et les modérateurs qui pourront toujours voir ce champ. Si l’option d’affichage dans le panneau de l’utilisateur est désactivée, l’utilisateur ne pourra pas voir ou modifier ce champ, seuls les administrateurs le pourront.',
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'Comme vous avez plus d’une langue installée, vous devez aussi remplir les éléments de langue restants. Le champ de profil fonctionnera avec la langue activée par défaut, vous pourrez également remplir ces éléments restants ultérieurement.',
