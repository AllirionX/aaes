...
<div id = "content">
<div class="texte">
<h2>Inscription pour les <span class="red">bénévoles</span>.</h2>
<h2>Attention à bien choisir une <span class="red">option</span> pour indiquer votre rôle préféré !</h2>
</div>

<iframe id="haWidget" src="https://www.helloasso.com/associations/amicale-des-amateurs-d-excursions-scenarisees-aaes/evenements/soiree-zombie-2017-benevoles/widget" style="width:800px;height:1150px;border:none;"></iframe><div style="width:800px;text-align:center;">Propulsé par <a href="https://www.helloasso.com" rel="nofollow">HelloAsso</a></div>
<!--
<div id ="title">
<h1>Réservation</h1>
